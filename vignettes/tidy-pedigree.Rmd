...
The pedigree can be visualized with `visped()`. Monoecious individuals are drawn as **hexagons** with teal edges and fill, while selfing edges are shown in the same teal color:

```{r plant-selfing-plot, fig.width=5, fig.height=4}
