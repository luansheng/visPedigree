...
#> Pedigree saved to: /tmp/RtmpIYBjON/file666615e37276.pdf
#> Label cex: 0.25. Symbol size: 5.5. Adjust 'cex' and 'symbolsize' if labels are too large or small.
...
#> Pedigree saved to: /tmp/RtmpIYBjON/file66663c5914f6.svg
...
#> Pedigree saved to: /tmp/RtmpIYBjON/file66661817043d.pdf
...
visped(big_ped_tidy, 
       ...
       file = tempfile(fileext = ".pdf"))
#> Note: Removed 351 isolated individuals (no parents, no progeny) from the plot.
#> Pedigree saved to: /tmp/RtmpIYBjON/file66666005fb71.pdf
