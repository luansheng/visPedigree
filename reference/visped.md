...
#> Pedigree saved to: /tmp/RtmpgQF5Gd/file1b8414709dca.pdf
#> Label cex: 0.25. Symbol size: 5.5. Adjust 'cex' and 'symbolsize' if labels are too large or small.
...
#> Pedigree saved to: /tmp/RtmpgQF5Gd/file1b845e80b9e3.svg
...
#> Pedigree saved to: /tmp/RtmpgQF5Gd/file1b845219dc54.pdf
...
visped(big_ped_tidy, 
       ...
       file = tempfile(fileext = ".pdf"))
#> Note: Removed 351 isolated individuals (no parents, no progeny) from the plot.
#> Pedigree saved to: /tmp/RtmpgQF5Gd/file1b84261a079f.pdf
