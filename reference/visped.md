...
#> Pedigree saved to: /tmp/RtmpCTGP6C/file5ac15a71eafa.pdf
#> Label cex: 0.25. Symbol size: 5.5. Adjust 'cex' and 'symbolsize' if labels are too large or small.
...
#> Pedigree saved to: /tmp/RtmpCTGP6C/file5ac17fdddf2f.svg
...
#> Pedigree saved to: /tmp/RtmpCTGP6C/file5ac17a177ed.pdf
...
visped(big_ped_tidy, 
       ...
       file = tempfile(fileext = ".pdf"))
#> Note: Removed 351 isolated individuals (no parents, no progeny) from the plot.
#> Pedigree saved to: /tmp/RtmpCTGP6C/file5ac146f3c784.pdf
