...
#> Pedigree saved to: /tmp/Rtmp3zUZUD/file1c5c56eaba14.pdf
#> Label cex: 0.25. Symbol size: 5.5. Adjust 'cex' and 'symbolsize' if labels are too large or small.
...
#> Pedigree saved to: /tmp/Rtmp3zUZUD/file1c5c64a99c04.pdf
...
visped(big_ped_tidy, 
       ...
       file = tempfile(fileext = ".pdf"))
#> Note: Removed 351 isolated individuals (no parents, no progeny) from the plot.
#> Pedigree saved to: /tmp/Rtmp3zUZUD/file1c5c35ab76e8.pdf
