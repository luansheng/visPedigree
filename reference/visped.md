...
#> Pedigree saved to: /tmp/RtmpU8QGxX/file1bd83bd22b82.pdf
#> Label cex: 0.25. Symbol size: 5.5. Adjust 'cex' and 'symbolsize' if labels are too large or small.
...
#> Pedigree saved to: /tmp/RtmpU8QGxX/file1bd8766c8910.svg
...
#> Pedigree saved to: /tmp/RtmpU8QGxX/file1bd82caae224.pdf
...
visped(big_ped_tidy, 
       ...
       file = tempfile(fileext = ".pdf"))
#> Note: Removed 351 isolated individuals (no parents, no progeny) from the plot.
#> Pedigree saved to: /tmp/RtmpU8QGxX/file1bd8544e2790.pdf
