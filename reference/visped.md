...
#> Pedigree saved to: /tmp/RtmpWpiYSO/file1c3a32c1ccc1.pdf
#> Label cex: 0.25. Symbol size: 5.5. Adjust 'cex' and 'symbolsize' if labels are too large or small.
...
#> Pedigree saved to: /tmp/RtmpWpiYSO/file1c3a9cb6d7f.svg
...
#> Pedigree saved to: /tmp/RtmpWpiYSO/file1c3a79728c91.pdf
...
visped(big_ped_tidy, 
       ...
       file = tempfile(fileext = ".pdf"))
#> Note: Removed 351 isolated individuals (no parents, no progeny) from the plot.
#> Pedigree saved to: /tmp/RtmpWpiYSO/file1c3a2b765f34.pdf
