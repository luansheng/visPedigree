...
#> Pedigree saved to: /tmp/Rtmpir4iWc/file27ad2915aac4.pdf
#> Label cex: 0.25. Symbol size: 5.5. Adjust 'cex' and 'symbolsize' if labels are too large or small.
...
#> Pedigree saved to: /tmp/Rtmpir4iWc/file27ad5673fdbd.svg
...
#> Pedigree saved to: /tmp/Rtmpir4iWc/file27ad52cd5a91.pdf
...
visped(big_ped_tidy, 
       ...
       file = tempfile(fileext = ".pdf"))
#> Note: Removed 351 isolated individuals (no parents, no progeny) from the plot.
#> Pedigree saved to: /tmp/Rtmpir4iWc/file27ad3b0750fd.pdf
