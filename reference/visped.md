...
#> Pedigree saved to: /tmp/RtmpMlmNvt/file68456acad0cf.pdf
#> Label cex: 0.25. Symbol size: 5.5. Adjust 'cex' and 'symbolsize' if labels are too large or small.
...
#> Pedigree saved to: /tmp/RtmpMlmNvt/file68455426f2e2.svg
...
#> Pedigree saved to: /tmp/RtmpMlmNvt/file68452bb11135.pdf
...
visped(big_ped_tidy, 
       ...
       file = tempfile(fileext = ".pdf"))
#> Note: Removed 351 isolated individuals (no parents, no progeny) from the plot.
#> Pedigree saved to: /tmp/RtmpMlmNvt/file684561ec771f.pdf
