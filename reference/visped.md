...
#> Pedigree saved to: /tmp/RtmpdsCSR3/file1c1c41cd737c.pdf
#> Label cex: 0.25. Symbol size: 5.5. Adjust 'cex' and 'symbolsize' if labels are too large or small.
...
#> Pedigree saved to: /tmp/RtmpdsCSR3/file1c1c54c21db1.svg
...
#> Pedigree saved to: /tmp/RtmpdsCSR3/file1c1c3e96e42f.pdf
...
visped(big_ped_tidy, 
       ...
       file = tempfile(fileext = ".pdf"))
#> Note: Removed 351 isolated individuals (no parents, no progeny) from the plot.
#> Pedigree saved to: /tmp/RtmpdsCSR3/file1c1c2498761c.pdf
